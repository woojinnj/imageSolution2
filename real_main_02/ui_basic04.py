...
class QTextEditLogger(logging.Handler):
    def __init__(self, parent):
        ...
        self.signal.new_log.connect(self.widget.appendPlainText)

    def emit(self, record):
        msg = self.format(record)
        self.signal.new_log.emit(msg)  # <-- 여기 중요: GUI 스레드로 안전하게 전달
...
class LogViewer(QtWidgets.QDialog):
    def __init__(self, app: FastAPI, parent=None):
        ...
        self.resize(800, 600)  # ✅ 여기에서 창 크기 설정
        ...
        layout.addWidget(self.logTextBox.widget,stretch=5)
